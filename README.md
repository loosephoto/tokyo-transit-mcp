...
**都心の主要観光スポットも対応**:
東京ドームシティ・後楽園（後楽園）、六本木ヒルズ（六本木）、麻布十番商店街（麻布十番）、表参道・青山（表参道）、増上寺（芝公園）、浜離宮恩賜庭園（竹芝）、築地場外市場（築地）、豊洲市場・teamLab（豊洲）、皇居・二重橋（東京）、国会議事堂（永田町）など。「Roppongi Hills」「Tokyo Dome City」「Omotesando」「Tsukiji Market」「Imperial Palace」等の英語名でも検索できます。
