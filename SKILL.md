...
### v2.42.0（2026-08-14）— コミュニティバス案内を目的地（降車駅）基準に改善
...
- **検証**: `npm run build` 成功・`test-contextual-display-routines` 全項目 PASS（コミュニティバス目的地化・バス無し駅 の回帰テスト追加、gov_facility_search_support テストを現行仕様 v2.36.3 に修正）
