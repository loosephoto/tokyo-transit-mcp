...
const pairs = [
  ...
  ['都庁前', '西新宿', 0, 10],                      // 大江戸線⇔丸ノ内線（地下連絡通路直結）
  ['馬喰町', '馬喰横山', 0, 10],                    // JR⇔都営新宿線（地下通路直結・連絡改札）
  ['上野広小路', '上野御徒町', 0, 10],              // 銀座線⇔大江戸線（地下通路直結）
  ['上野御徒町', '仲御徒町', 0, 10],                // 大江戸線⇔日比谷線（地下通路直結）
  ['新富町', '築地', 0, 10],                        // 有楽町線⇔日比谷線（同一駅扱い）
  ['銀座一丁目', '東銀座', 1, 12],                  // 有楽町線⇔浅草線・日比谷線（地下通路）
];
