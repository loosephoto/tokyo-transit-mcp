...
export const RAILWAY_NAME_MAP = {
  ...
  '千葉都市モノレール2号線': '千葉都市モノレール2号線',
  'モノレール2号線': '千葉都市モノレール2号線',
  ...
  '京成東成田線': '東成田線',
  '東成田線': '東成田線',
  '京成本線支線': '東成田線', // 旧表記（2026-09 東成田線に改名）
  '京成押上線': '京成押上線',
  '押上線': '京成押上線',
  '京成金町線': '京成金町線',
  '金町線': '京成金町線',
  ...
  '京成松戸線': '京成松戸線',
  '松戸線': '京成松戸線',
  '新京成線': '京成松戸線', // 2025-04-01 京成電鉄へ吸収合併・京成松戸線に改称（旧名も検索可）
  '新京成': '京成松戸線',
  '新京成電鉄': '京成松戸線',
  '京急大師線': '京急大師線',
  '大師線': '京急大師線',
  ...
  // 秩父鉄道秩父本線（2026-09 追加）: 「秩父線」の一般名は秩父鉄道側（西武秩父線は「西武秩父線」表記のみ）
  '秩父鉄道': '秩父鉄道秩父本線',
  '秩父鉄道秩父本線': '秩父鉄道秩父本線',
  '秩父本線': '秩父鉄道秩父本線',
  '秩父線': '秩父鉄道秩父本線',
...
export const STATION_DISPLAY_NAMES = {
  ...
  '毛呂': { en: 'Moro', zh: '毛吕' },
  '明覚': { en: 'Myogaku', zh: '明觉' },
  '竹沢': { en: 'Takezawa', zh: '竹泽' },
  '折原': { en: 'Orihara', zh: '折原' },
  '小川町（JR八高線）': { en: 'Ogawamachi (JR Hachiko Line)', zh: '小川町（JR八高线）' },
  '西羽生': { en: 'Nishi-Hanyu', zh: '西羽生' },
  '新郷': { en: 'Shingo', zh: '新乡' },
  '武州荒木': { en: 'Bushu-Araki', zh: '武州荒木' },
  '東行田': { en: 'Higashi-Gyoda', zh: '东行田' },
  '行田市': { en: 'Gyoda-shi', zh: '行田市' },
  '持田': { en: 'Mochida', zh: '持田' },
  'ソシオ流通センター': { en: 'Socio Distribution Center', zh: '索西奥流通中心' },
  '上熊谷': { en: 'Kami-Kumagaya', zh: '上熊谷' },
  '石原': { en: 'Ishihara', zh: '石原' },
  'ひろせ野鳥の森': { en: 'Hirose-Yacho-no-Mori', zh: '广濑野鸟之森' },
  '大麻生': { en: 'Oaso', zh: '大麻生' },
  '明戸': { en: 'Aketo', zh: '明户' },
  '武川': { en: 'Takekawa', zh: '武川' },
  '永田': { en: 'Nagata', zh: '永田' },
  'ふかや花園': { en: 'Fukaya-Hanazono', zh: '深谷花园' },
  '小前田': { en: 'Omaeda', zh: '小前田' },
  '桜沢': { en: 'Sakurazawa', zh: '樱泽' },
  '波久礼': { en: 'Hagure', zh: '波久礼' },
  '樋口': { en: 'Higuchi', zh: '樋口' },
  '野上': { en: 'Nogami', zh: '野上' },
  '長瀞': { en: 'Nagatoro', zh: '长瀞' },
  '上長瀞': { en: 'Kami-Nagatoro', zh: '上长瀞' },
  '親鼻': { en: 'Oyahana', zh: '亲鼻' },
  '皆野': { en: 'Minano', zh: '皆野' },
  '和銅黒谷': { en: 'Wado-Kuroya', zh: '和铜黑谷' },
  '大野原': { en: 'Onohara', zh: '大野原' },
  '秩父': { en: 'Chichibu', zh: '秩父' },
  '御花畑': { en: 'Ohanabatake', zh: '御花畑' },
  '影森': { en: 'Kagemori', zh: '影森' },
  '浦山口': { en: 'Urayamaguchi', zh: '浦山口' },
  '武州中川': { en: 'Bushu-Nakagawa', zh: '武州中川' },
  '武州日野': { en: 'Bushu-Hino', zh: '武州日野' },
  '白久': { en: 'Shiraku', zh: '白久' },
  '三峰口': { en: 'Mitsumineguchi', zh: '三峰口' },
  ...
  '鉄道博物館': { en: 'Tetsudo-Hakubutsukan (Railway Museum)', zh: '铁道博物馆' },
...
export const LINE_DISPLAY_NAMES = {
  ...
  '秩父鉄道秩父本線': { en: 'Chichibu Railway Main Line', zh: '秩父铁道秩父本线' },
  ...
  '東成田線': { en: 'Keisei Higashi-Narita Line', zh: '京成东成田线' },
  ...
  '京成松戸線': { en: 'Keisei Matsudo Line', zh: '京成松户线' },
  ...
  '千葉都市モノレール2号線': { en: 'Chiba Urban Monorail Line 2', zh: '千叶都市单轨电车2号线' },
