...
export const NON_RAIL_OPERATORS = {
  ...
  chibamonorail: { id: 'ChibaUrbanMonorail', type: 'monorail', label: '千葉都市モノレール', labelEn: 'Chiba Urban Monorail', labelZh: '千叶都市单轨电车', description: 'モノレール（懸垂式・世界最長）- 1号線・2号線', descEn: 'Monorail (suspended type, world longest) - Lines 1 & 2', descZh: '单轨电车（悬垂式、世界最长）- 1号线、2号线', website: 'https://chiba-monorail.co.jp/' },
