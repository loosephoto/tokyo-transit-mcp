...
export const RAILWAY_LINES = {
  ...
  '京成松戸線': ['京成津田沼','新津田沼','前原','薬園台','習志野','北習志野','高根木戸','高根公団','滝不動','三咲','二和向台','鎌ヶ谷大仏','初富','新鎌ヶ谷','北初富','くぬぎ山','元山','五香','常盤平','八柱','みのり台','松戸新田','上本郷','松戸'], // 2025-04-01 新京成線→京成松戸線に改称（京成津田沼起点・公式24駅）
  ...
  '埼玉新都市交通（ニューシャトル）': ['大宮','鉄道博物館','加茂宮','東宮原','今羽','吉野原','原市','沼南','丸山','志久','伊奈中央','羽貫','内宿'], // 鉄道博物館（大成）→鉄道博物館に改称（2026-09・公式NS02）
  '千葉都市モノレール1号線': ['千葉みなと','市役所前','千葉','栄町','葭川公園','県庁前'], // 公式6駅（千葉みなと⇔県庁前・Wikipedia/公式サイトで確定 2026-09）
  '千葉都市モノレール2号線': ['千葉','千葉公園','作草部','天台','穴川','スポーツセンター','動物公園','みつわ台','都賀','桜木','小倉台','千城台北','千城台'], // 公式13駅（千葉⇔千城台・2026-09 追加）
  ...
  'JR八高線': ['八王子','北八王子','小宮','拝島','東福生','箱根ケ崎','金子','東飯能','高麗川','毛呂','越生','明覚','小川町（JR八高線）','竹沢','折原','寄居'], // 2026-09 駅順修正: 東武越生線の駅（東毛呂・武州唐沢・川角・西大家）を除去し明覚・小川町・竹沢・折原を追加（Wikipedia駅一覧で確定）
...
export const WALK_TRANSFERS = [
  ...
  { from: '八柱', to: '新八柱', minutes: 3 },          // 京成松戸線 ⇔ JR武蔵野線（連絡通路）
  ...
  { from: '津田沼', to: '京成津田沼', minutes: 4 },      // JR総武線・京成松戸線 ⇔ 京成本線（連絡通路）
  { from: '津田沼', to: '新津田沼', minutes: 3 },          // JR総武線 ⇔ 京成松戸線（新津田沼・隣接乗換）
  { from: '小川町（JR八高線）', to: '小川町（東武東上線）', minutes: 3 },  // JR八高線 ⇔ 東武東上線（埼玉県小川町・隣接乗換駅）
