/**
 * Tokyo Transit MCP Server v2.37.0 (Production Ready)
...
const RAILWAY_LINES = {
  ...
  'JR武蔵野線（大崎支線）': ['大崎','西浦和'],
  'JR常磐線快速': ['上野','日暮里','三河島','南千住','北千住','綾瀬','亀有','金町','松戸','柏','我孫子','取手','藤代','龍ケ崎市'],
  'JR常磐線各停': ['上野','日暮里','三河島','南千住','北千住','綾瀬','亀有','金町','松戸','北松戸','馬橋','新松戸','北小金','南柏','柏','逆井','高柳','我孫子','天王台','取手','藤代','龍ケ崎市'],
...
const server = new Server(
  { name: 'tokyo-transit-mcp', version: '2.37.0' },
  { capabilities: { tools: {} } }
);
