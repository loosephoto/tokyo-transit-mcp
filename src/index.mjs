/**
 * Tokyo Transit MCP Server v2.23.0 (Production Ready)
...
const RAILWAY_LINES = {
  ...
  '東京メトロ丸ノ内線': ['池袋','新大塚','茗荷谷','後楽園','本郷三丁目','御茶ノ水','淡路町','大手町','東京','銀座','霞ケ関','国会議事堂前','赤坂見附','永田町','四ツ谷','四谷三丁目','新宿御苑前','新宿三丁目','新宿','西新宿','中野坂上','新中野','東高円寺','新高円寺','南阿佐ケ谷','荻窪'],
  ...
  '東京メトロ副都心線': ['和光市','地下鉄赤塚','地下鉄成増','小竹向原','千川','要町','池袋','雑司が谷','西早稲田','東新宿','新宿三丁目','北参道','明治神宮前','渋谷'],
  // ===== 私鉄（主要路線）=====
...
const server = new Server(
  { name: 'tokyo-transit-mcp', version: '2.23.0' },
  { capabilities: { tools: {} } }
);
